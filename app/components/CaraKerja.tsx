    ...
    <section className="px-4 sm:px-6 lg:px-8 pb-16 sm:pb-20">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          <div className="hidden md:block absolute top-12 left-[16.66%] right-[16.66%] h-0.5 bg-linear-to-r from-emerald-200 via-emerald-300 to-emerald-200 dark:from-emerald-800/40 dark:via-emerald-700/40 dark:to-emerald-800/40" />
