...
export default function ChatBox({
  ...
  return (
    <div className="backdrop-blur-xl bg-white/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100/80 rounded-3xl p-5 sm:p-6">
          ...
          <div key={idx} className="space-y-2">
            ...
            {log.answer && (
              <div className="flex justify-start">
                <div className="max-w-[85%] sm:max-w-[75%] bg-slate-100/90 border border-slate-200/60 text-slate-700 text-sm rounded-2xl rounded-bl-md px-4 py-2.5 shadow-[0_2px_8px_rgb(0,0,0,0.02)]">
            ...
            {!log.answer && (
              <div className="flex justify-start">
                <div className="bg-slate-100/90 border border-slate-200/60 text-slate-400 text-sm rounded-2xl rounded-bl-md px-4 py-3 shadow-[0_2px_8px_rgb(0,0,0,0.02)]">
      ...
      {isSessionClosed && (
        <div className="mb-4 p-4 bg-slate-50/90 border border-slate-200/80 rounded-2xl flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-emerald-100 flex items-center justify-center flex-shrink-0">
            <LockKeyhole className="w-4 h-4 text-emerald-600" />
          </div>
          <div>
            <p className="text-sm font-bold text-slate-800">Sesi Konsultasi Ditutup</p>
      ...
      <form onSubmit={handleSubmit} className="flex items-center gap-2.5">
        <input
          ...
          className="flex-1 px-4 py-3 rounded-2xl bg-white border border-slate-200/80 text-slate-800 placeholder:text-slate-400/70 text-sm transition-all duration-200 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 focus:outline-none shadow-[0_2px_8px_rgb(0,0,0,0.02)] disabled:opacity-50 disabled:cursor-not-allowed"
        />
        <button
          type="submit"
