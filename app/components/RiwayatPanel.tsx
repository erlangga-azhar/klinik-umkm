    ...
    <div className="mb-6 backdrop-blur-xl bg-white/80 dark:bg-zinc-900/90 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.3)] border border-slate-100/80 dark:border-zinc-800/80 rounded-3xl p-5 relative overflow-visible">
      ...
      {showConfirmDelete && (
        <div className="absolute inset-0 z-20 flex items-center justify-center bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm rounded-3xl p-5">
          <div className="bg-white dark:bg-zinc-900 border border-slate-100/80 dark:border-zinc-800/80 rounded-2xl shadow-[0_12px_40px_rgb(0,0,0,0.08)] dark:shadow-[0_12px_40px_rgb(0,0,0,0.4)] p-5 max-w-sm w-full text-center">
            <div className="w-12 h-12 mx-auto mb-3 rounded-2xl bg-rose-50 dark:bg-rose-950/40 border border-rose-100 dark:border-rose-900/60 flex items-center justify-center">
              <AlertTriangle className="w-6 h-6 text-rose-500" />
            </div>
            <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1">Hapus Semua Riwayat?</h4>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-2.5 px-4 bg-white dark:bg-zinc-800 border border-slate-200/80 dark:border-zinc-700/80 hover:bg-slate-50 dark:hover:bg-zinc-700 text-slate-700 dark:text-zinc-300 font-semibold text-xs rounded-xl transition-all duration-200"
              >
                Batal
              </button>
              <button
        ...
        {history.map((item: HistoryItem) => (
          ...
          >
            <div className="min-w-0 flex-1 flex items-center gap-3">
              ...
              <div>
                <span className="block text-sm font-semibold text-slate-800 dark:text-zinc-100 truncate leading-tight">
